  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        style={
          {
            "--color-chart-0": "hsl(var(--primary))",
            "--color-chart-1": "hsl(var(--secondary))",
            "--color-chart-2": "hsl(var(--accent))",
            "--color-chart-3": "hsl(var(--muted))",
            "--color-chart-4": "hsl(var(--muted-foreground))",
                  ...
                  <div key={index} className="flex items-center justify-between gap-2 text-sm">
                    <div className="flex items-center gap-1">
                      <div
                        ...
                        style={{
                          backgroundColor: config?.color ?? item.fill,
                        }}
                      />
...
export { ChartTooltip, ChartLegend, ChartLegendContent }
